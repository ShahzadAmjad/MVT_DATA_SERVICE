...
namespace PeeringDB_Data_Import.Models
{
    public class pdb_internet_exchange_networks
    {
        ...
        public Ix_pdb_internet_exchange_networks ix { get; set; }
        ...
        public List<NetSet_pdb_internet_exchange_networks> net_set { get; set; }
    ...
    public class Ix_pdb_internet_exchange_networks
    {
        public int id { get; set; }
        public int org_id { get; set; }
        public Org_pdb_internet_exchange_networks org { get; set; }
        public string name { get; set; }
    ...
    public class NetSet_pdb_internet_exchange_networks
    {
        public int id { get; set; }
        public int org_id { get; set; }
        public string name { get; set; }
    ...
    public class Org_pdb_internet_exchange_networks
    {
        public int id { get; set; }
        public string name { get; set; }
        public string aka { get; set; }
    ...
    public class Root_pdb_internet_exchange_networks
    {
        public List<pdb_internet_exchange_networks> data { get; set; }
