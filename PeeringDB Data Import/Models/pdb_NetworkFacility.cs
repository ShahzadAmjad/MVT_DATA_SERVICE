...
{
    public class pdb_NetworkFacility
    {
    ...
    public class Fac
    {
        ...
        public Org_pdb_NetworkFacility org { get; set; }
        public string name { get; set; }
    ...
    public class Org_pdb_NetworkFacility
    {
        public int id { get; set; }
        public string name { get; set; }
        public string aka { get; set; }
    ...
    public class Root_pdb_NetworkFacility
    {
        public List<pdb_NetworkFacility> data { get; set; }
