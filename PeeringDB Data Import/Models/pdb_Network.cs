...
namespace PeeringDB_Data_Import.Models
{
    public class pdb_Network
    {
        ...
        public List<NetfacSet> netfac_set { get; set; }
        public List<NetixlanSet> netixlan_set { get; set; }
        public List<object> poc_set { get; set; }
    ...
    //    public List<object> fac_set { get; set; }
    //    public List<object> ix_set { get; set; }
    ...
    public class Root_pdb_Network
    {
        public List<pdb_Network> data { get; set; }
